...
# indoor_scene_reckognition documentation build
...
from indoor_scene_reckognition import __version__ as release

# -- Project information -----------------------------------------------------

project = "indoor_scene_reckognition"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "indoor_scene_reckognitiondoc"
...
latex_documents = [
    (
        master_doc,
        "indoor_scene_reckognition.tex",
        "indoor_scene_reckognition Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "indoor_scene_reckognition",
        "Project indoor_scene_reckognition codebase.",
        "Data-Science",
    )
]
